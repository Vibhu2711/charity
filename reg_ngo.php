...
<html class="no-js"> <!--<![endif]-->
	...
	<body>
		...
		<?php
				...
				{
					$sql="INSERT INTO `ngo_registration` (`name`, `email-id`,`phone_no`, `address`, `city`, `state`, `password`) VALUES ('$uname', '$eid', '$phone', '$add', '$city', '$state', '$encoded')";
			...
			<div class="col">
				...
				<div class="row g-0">
					...
					<div class="card-body p-md-5 text-black">
						<h3 class="mb-5 text-uppercase">NGO Registration</h3>
						<form method="post">
						<div class="row">
						...
						<button type="submit" name="submit" onclick="fill_up_n()" class="btn btn-warning btn-lg ms-2">Submit form</button>
						</div>
